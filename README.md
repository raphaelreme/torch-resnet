...
test set (No validation is done).
...
|ResNet1001           |10.3M |[Failed (90.00)](https://tensorboard.dev/experiment/Z9y7UGqIQQWcarrj613nOQ)     |xxx                |Failed (99.00)                                                                | 27.82 [2]           |
...
|PreActResNet1202     |19.4M |[6.66](https://tensorboard.dev/experiment/e7WPBDcbRwuZRJReQsoPFg)               |xxx                |xx.xx $\pm$ x.xx                                                              | xxx                 |
...
Note that in [2] and in most github implementation, the test set is used as a validation set (taking the max acc reached on it as the final result), obviously leading to falsely better performances. When dropping AMP and taking the max value rather than the last value, we also reach better performances. (TODO)
